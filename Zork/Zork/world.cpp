...
World::World()
{
	...
	answers.push_back(answer);
	answer.key = "Susan";
	answer.answer = "She is my wife, I was with her all last night";
	answers.push_back(answer);
	answer.key = "Hair";
	answer.answer = "Could be my wife's hair";
	answers.push_back(answer);
	answer.key = "Photo";
	...
	answers.push_back(answer);
	Person* albert = new Person("Albert", "Albert Queen a rich man", bedroom2, true, false, "Yesterday I was all nigth with my wife", answers);
	...
	answers.push_back(answer);
	answer.key = "Hair";
	answer.answer = "It is my hair. You say me that was in the Robert's bathdroom. I does not nhow how could it get there";
	answers.push_back(answer);
	answer.key = "Photo";
	answer.answer = "Ok. I admit, Robert and I were lovers. Last night we took a bath together in his bedroom. But I left before 21:00";
	answers.push_back(answer);
	answer.key = "Knife";
	answer.answer = "This is mi knife, where do you found it? I lost yesterday. I use this knife to cook. I am a chef";
	answers.push_back(answer);
	Person* susan = new Person("Susan", "Susan Queen a sexy lady with red hair an blue eyes", reception, true, false, "Yesterday I was in the bar until 00:00, and them I went my room to sleep.", answers);
	reception->container.push_back(susan);
	answers.clear();
	Person* receptionist = new Person("Receptionist", "Kelly Danvers receptionist", reception, false, true, "I call the Mr. Lewis room this morning to wake up him. And how I did not get response, I went to the room and I saw him. Then I call the police. I did not know any more, this is my first day", answers);
	...
	answers.push_back(answer);
	answer.key = "Albert";
	answer.answer = "He was drinking at the bar from 7:00 p.m. and went along with Robert. He was very drunk";
	answers.push_back(answer);
	answer.key = "Susan";
	answer.answer = "She arrived with Robert, and she was drinking until 00:00";
	answers.push_back(answer);
